...
const Page = () => {
  ...
  return (
    (song && (
      <>
        <div className="flex flex-col items-center justify-end text-center align-bottom h-[300px] w-full">
          <motion.div
            className={clsx(
              "flex flex-row items-center justify-center align-middle w-full fixed top-[56px] lg:top-0 lg:left-72 lg:w-[calc(100dvw-256px-8px)] md:gap-5",
              "bg-background"
            )}
            style={{
              height: scrollHeight
    ...
    (!token && (
      ...
      <>
        <p className="relative top-[56px]">Loading currently playing song...</p>
      </>
    )
  );
};
